        ...
        <div class="row">
            <div class="column">
                    <div class="card">
                        ...
                        <h2 class="cabecera">DISEÑO PÁGINAS WEB<span>ELEMENTAL</span></h2>
                        <p class="precio">1.099.000<span>COP + IVA</span></p>
            ...
            <div class="column">
                    <div class="card">
                        ...
                        <h2 class="cabecera">DISEÑO PÁGINAS WEB <br><span>ARCANO</span></h2>
                        <p class="precio">1.099.000<span>COP + IVA</span></p>
                        <a href="#contact" class="info" >Solicita más información</a>
                        <br>
                        <br>
                        ...
                        <hr>
                        <br>
                        <p>Hasta 10 secciones de navegación </p>
                        <p>Administrador de Contenidos</p>
                        <p>Diseño ajustado a la marca</p>
                        <p>Banner dinamico</p>
                        <p>Adaptable a Movil, Tablets y PCs</p>
                        <p>Formulario de Contacto (Básico)</p>
                        <p>Links a Redes Sociales</p>
                        ...
                        <p>Incluye Hosting y Dominio</p>
                        <p>5 Cuentas de correo corporativo</p>
                        <p>Integración código google analitys</p>
                        <p>Blog – Noticias</p>
            ...
            <div class="column">
                    <div class="card">
                        ...
                        <h2 class="cabecera">DISEÑO PÁGINAS WEB <br><span>LEGENDARIO</span></h2>
                        <p class="precio">1.099.000<span>COP + IVA</span></p>
                        <a href="#contact" class="info" >Solicita más información</a>
                        <br>
                        <br>
                        ...
                        <hr>
                        <br>
                        <p>Hasta 17 secciones de navegación </p>
                        <p>Administrador de Contenidos</p>
                        <p>Diseño personalizado</p>
                        <p>banner estatico</p>
                        <p>Adaptable a Movil, Tablets y PCs</p>
                        <p>Formulario de Contacto (Perzonalizado)</p>
                        <p>Links a Redes Sociales</p>
                        <p>Google maps</p>
                        <p>Botón WhatsApp</p>
                        <p>Certificado SSL</p>
                        ...
                        <p>Amigable con el SEO</p>
                        <p>Incluye Hosting y Dominio</p>
                        <p>10 Cuentas de correo corporativo</p>
                        <p>Blog – Noticias</p>
                        <p>Galería de fotos o videos</p>
                        <p>Diseño personalizado</p>
                        <p>Google my bussines</p>
                        <p>Chat online</p>
